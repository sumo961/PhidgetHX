...
class PhidgetServoParameters
{
    public var servoType : Int;
    public var minUs : Float;
    public var maxUs : Float;
    public var usPerDegree : Float;
    public var maxUsPerS : Float;
    
    @:allow(com.phidgets)
    private function new(servoType : Int, minUs : Float, maxUs : Float, usPerDegree : Float, maxUsPerS : Float)
    {
    ...
    public function usToDegrees(us : Float) : Float
    {
        return (us - minUs) / usPerDegree;
    }
    public function degreesToUs(degrees : Float) : Float
    {
        return (degrees + (minUs / usPerDegree)) * usPerDegree;
    }
    public function usToDegreesVel(us : Float) : Float
    {
        return us / usPerDegree;
    }
    public function degreesToUsVel(degrees : Float) : Float
    {
    ...
    public static function getServoParams(servoType : Int) : PhidgetServoParameters
    {
        switch (servoType)
        {
